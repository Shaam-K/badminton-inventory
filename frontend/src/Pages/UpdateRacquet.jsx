...
const UpdateRacquet = () => {
    ...
    return (
        <section className="flex flex-col justify-center items-center mt-5">
            ...
            <form onSubmit={HandleSubmit} method="put" encType="multipart/form-data" className="flex flex-col items-left xl:w-[40%] md:w-[60%] w-[90%]">
                ...
                <input type="submit" value="Update Racquet" className="my-3 bg-blue-300 p-3 hover:bg-blue-500 hover:text-white cursor-pointer transition-all" />
